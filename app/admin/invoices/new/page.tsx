    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-zinc-600 dark:text-zinc-400">
          <strong className="font-medium text-zinc-800 dark:text-zinc-200">Standard one-off invoices only</strong>{" "}
          (hardware, installation, cash, bank). Retainers and recurring schedules are managed in Invoiless, not here.
          For card subscriptions, use <strong className="font-medium">Customer → Billing</strong> (Stripe).
          Currency follows{" "}
