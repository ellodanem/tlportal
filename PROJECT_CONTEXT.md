...
### 2026-06-30 09:29 UTC — commit `57ca69c`

- docs: sync project context log from git hooks


### 2026-06-30 09:29 UTC — pre-push (`main` → origin) @ `57ca69c`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-06-30 09:53 UTC — commit `0860430`

- feat(billing): native billing Phase 3 recurring invoices


### 2026-06-30 09:54 UTC — pre-push (`main` → origin) @ `0860430`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-06-30 09:57 UTC — commit `3cb0755`

- feat(billing): native billing Phase 4 Stripe AR mirror


### 2026-06-30 09:57 UTC — pre-push (`main` → origin) @ `3cb0755`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-06-30 09:59 UTC — commit `310bd2f`

- docs: sync project context log from git hooks


### 2026-06-30 09:59 UTC — pre-push (`main` → origin) @ `310bd2f`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-06-30 10:10 UTC — commit `491325a`

- feat(billing): native billing Phase 5 expenses register


### 2026-06-30 10:10 UTC — pre-push (`main` → origin) @ `491325a`
...
### 2026-07-14 09:44 UTC — commit `6e96af6`

- docs: record push entry in project context log


### 2026-07-14 09:44 UTC — pre-push (`main` → origin) @ `6e96af6`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:13 UTC — commit `0ec63e3`

- feat(billing): verify checkout send with channel status and logs


### 2026-07-15 10:13 UTC — pre-push (`main` → origin) @ `0ec63e3`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:14 UTC — commit `e8998f2`

- docs: record checkout send verification in project context log


### 2026-07-15 10:14 UTC — pre-push (`main` → origin) @ `e8998f2`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:22 UTC — commit `91c1c2b`

- fix(billing): show saved plan term in Payment & plan modal


### 2026-07-15 10:22 UTC — pre-push (`main` → origin) @ `91c1c2b`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:23 UTC — commit `9838da7`

- docs: record saved plan term fix in project context log


### 2026-07-15 10:23 UTC — pre-push (`main` → origin) @ `9838da7`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:23 UTC — commit `11f7835`

- docs: sync project context log from git hooks


### 2026-07-15 10:23 UTC — pre-push (`main` → origin) @ `11f7835`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:35 UTC — commit `5ab1cf6`

- Clarify checkout payment-link auto-charge wording for email and WhatsApp.


### 2026-07-15 10:35 UTC — pre-push (`main` → origin) @ `5ab1cf6`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:35 UTC — commit `4f03dd9`

- docs: sync project context log from git hooks


### 2026-07-15 10:35 UTC — pre-push (`main` → origin) @ `4f03dd9`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:35 UTC — commit `19ac172`

- docs: record push entry in project context log


### 2026-07-15 10:35 UTC — pre-push (`main` → origin) @ `19ac172`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:59 UTC — commit `960ea3c`

- Align WhatsApp checkout preview with approved Twilio payment-link templates.


### 2026-07-15 10:59 UTC — pre-push (`main` → origin) @ `960ea3c`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-15 10:59 UTC — commit `59c04fe`

- docs: sync project context log from git hooks


### 2026-07-15 10:59 UTC — pre-push (`main` → origin) @ `59c04fe`
...
### 2026-07-29 20:58 UTC — commit `6bc8a05`

- docs: sync project context log from git hooks


### 2026-07-29 20:58 UTC — pre-push (`recovery/recovered-pc-2026-07-29` → origin) @ `6bc8a05`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-29 21:01 UTC — commit `6e2e594`

- docs: sync project context log from git hooks


### 2026-07-30 10:03 UTC — commit `309c38f`

- docs: sync project context log from git hooks


### 2026-07-30 10:03 UTC — pre-push (`main` → origin) @ `309c38f`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-07-30 10:03 UTC — commit `fd38378`

- docs: sync project context log from git hooks


### 2026-07-30 10:03 UTC — pre-push (`main` → origin) @ `fd38378`
...
### 2026-08-04 23:34 UTC — commit `dc6e329`

- docs: sync project context log from git hooks


### 2026-08-04 23:34 UTC — pre-push (`main` → origin) @ `dc6e329`
...
### 2026-08-10 11:04 UTC — commit `2559ad5`

- docs: sync project context log from git hooks


### 2026-08-10 11:04 UTC — pre-push (`main` → origin) @ `2559ad5`
...
### 2026-08-17 10:23 UTC — commit `1fc2c21`
...
### 2026-08-17 10:25 UTC — commit `87e6aff`

- docs: sync project context log from git hooks


### 2026-08-17 10:25 UTC — pre-push (`main` → origin) @ `87e6aff`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-08-25 22:30 UTC — commit `ffde50b`

- feat(admin): add customer account statements with PDF export


### 2026-08-25 22:30 UTC — pre-push (`main` → origin) @ `ffde50b`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-08-25 22:32 UTC — commit `2d85a8c`

- Show an active-services total on the customers list, with paused counted separately.


### 2026-08-25 22:32 UTC — pre-push (`main` → origin) @ `2d85a8c`
...
### 2026-09-04 22:19 UTC — commit `d55a562`

- docs: sync project context log from git hooks


### 2026-09-04 22:19 UTC — pre-push (`main` → origin) @ `d55a562`
...
### 2026-09-04 22:29 UTC — commit `13a926d`

- docs: sync project context log from git hooks


### 2026-09-04 22:29 UTC — pre-push (`main` → origin) @ `13a926d`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-09-04 22:30 UTC — commit `dad1ac2`

- docs: sync project context log from git hooks


### 2026-09-04 22:30 UTC — pre-push (`main` → origin) @ `dad1ac2`
...
### 2026-09-05 18:02 UTC — commit `2e00684`

- docs: sync project context log from git hooks


### 2026-09-05 18:02 UTC — pre-push (`main` → origin) @ `2e00684`
...
### 2026-09-05 18:17 UTC — commit `361e85f`

- docs: sync project context log from git hooks


### 2026-09-05 18:17 UTC — pre-push (`main` → origin) @ `361e85f`
...
### 2026-09-12 09:50 UTC — commit `9cbcaf7`

- docs: sync project context log from git hooks


### 2026-09-12 09:50 UTC — pre-push (`main` → origin) @ `9cbcaf7`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-09-21 11:56 UTC — commit `dc50f84`

- docs: sync project context log from git hooks


### 2026-09-21 11:56 UTC — commit `778de12`

- docs: sync project context log from git hooks


### 2026-09-21 11:56 UTC — pre-push (`main` → origin) @ `778de12`
...
### 2026-09-25 11:12 UTC — commit `a6bec52`

- docs: sync project context log from git hooks


### 2026-09-25 11:12 UTC — pre-push (`main` → origin) @ `a6bec52`

- Hook runs before upload; if the push fails, this entry still exists (edit or add a follow-up note).


### 2026-09-25 11:15 UTC — commit `f5b6458`

- Fix missing try around customer update so production build can parse.
